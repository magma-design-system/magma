...
We've have made this/these changes:
...
| 🟢 | *patch*    | `docs`    | `mds-accordion` | Add doc on how handle events |
...
| 🟢 | *patch*    | `refactor` | `design-tokens` | Separate color tokens from typography ones |
