...
│   ├── stencil-angular/   # @maggioli-design-system/magma-angular — Angular wrappers (generated by stencil)
│   ├── stencil-react/     # @maggioli-design-system/magma-react — React wrappers (generated by stencil)
...
| `stencil`         | `@maggioli-design-system/magma`          | The web components library and its Storybook; its build also generates the wrapper sources    |
| `stencil-react`   | `@maggioli-design-system/magma-react`    | React wrappers of the web components (sources generated by the `stencil` build)               |
| `stencil-angular` | `@maggioli-design-system/magma-angular`  | Angular wrappers of the web components (sources generated by the `stencil` build)             |
