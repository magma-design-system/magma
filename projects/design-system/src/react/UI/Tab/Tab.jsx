...
const TabItem = ({ active, borderRadius, className, ...restProps }) => {
  const classes = styles('tab__item', {
    selectors: [
      className,
      active ? 'background-color-brand-maggioli-05 color-adjust-tone-20' : 'background-color-adjust-tone-19 background-color-adjust-tone-20:hover box-shadow-box:hover color-adjust-tone-04',
    ],
    scaffolded: {
      borderRadius,
    },
