...
BackofficePageLoginHeader.defaultProps = {
  logo: require('#Assets/brand/gruppo-maggioli/logo-gruppo-maggioli.svg'),
  ...
  return <Grid gutter="small" className="backoffice-page-login__footer">
    ...
    <div>
      <Row width="inline">
        ...
        <Icon size="normal" image={require('#Assets/brand/gruppo-maggioli/logo-gruppo-maggioli.svg')}/>
