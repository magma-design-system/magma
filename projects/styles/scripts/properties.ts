...
// The generated corner axis, where `--magma-radius-*` is pointed at the scale of
// the default shape. Generated by corner.ts, which therefore runs BEFORE this.
const CORNER_CSS = path.resolve(BUILD_DIR, 'css', 'corner.css');
...
const main = async () => {
  ...
  const lookup = await buildLookup([...tokenFiles, SEMANTIC_CSS, CORNER_CSS, GLOBALS_CSS]);
