...
const ArticleSimpleContent: FC<ComponentProps> = ({ className }): JSX.Element =>
  <div className="grid grid-cols-4 gap-6">
    <div className="col-span-3 grid gap-6">
      ...
      <mds-text typography="paragraph" class="max-w-text">Da oltre 115 anni siamo una Family Company che da ben quattro generazioni ama definirsi usando l’espressione “innovatori per tradizione”: un’espressione che racchiude il nostro spirito impren­ditoriale e ben interpreta i principi ed i valori alla base della nostra cultura d'impresa.</mds-text>
