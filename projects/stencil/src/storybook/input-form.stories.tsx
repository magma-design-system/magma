    ...
    <div class="grid gap-300">
      ...
      <div class="grid gap-x-600 gap-y-300 grid-cols-fit-md">
        <mds-input-field label="temporary code">
          <mds-input type="text" placeholder="Es: MROBRS86R14D788J" name="secretPhrase" readonly value="BFG9000"></mds-input>
        </mds-input-field>
        <mds-input-field label="Confirm madness">
          <mds-input type="text" placeholder="Es: MROBRS86R14D788J" name="madness" disabled value="I confirm I'm MAD"></mds-input>
        </mds-input-field>
      </div>
      <div class="grid gap-x-600 gap-y-300 grid-cols-fit-md">
      ...
      <mds-input-field label="Bigraphy">
        <mds-input type="textarea" placeholder="Es: I would like to save the world, but first I'll try to save myself" name="bigraphy" maxlength={350}></mds-input>
      </mds-input-field>
      ...
      <div class="grid gap-x-600 gap-y-300 grid-cols-fit-md">
        <div></div>
        <mds-button type="submit" size="lg">Submit</mds-button>
      </div>
    </div>
  </form>
}
