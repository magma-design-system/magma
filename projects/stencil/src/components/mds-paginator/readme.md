...
| ------------- | -------------- | ---------------------------------------------------- | --------------------- | ------- |
| `currentPage` | `current-page` | Specifies the current page selected in the paginator | `number \| undefined` | `1`     |
| `pages`       | `pages`        | Specifies the number of total pages to be handled    | `number \| undefined` | `0`     |
