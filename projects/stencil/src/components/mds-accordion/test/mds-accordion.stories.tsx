...
const Template = args =>
  <mds-accordion {...args}>
    <mds-accordion-item description="Blipbug" closable={args.closable}>
    ...
    <mds-accordion-item description="Drednaw" closable={args.closable}>
    ...
    <mds-accordion-item description="Orbeetle" closable={args.closable}>
    ...
    <mds-accordion-item description="Dottler" closable={args.closable}>
    ...
    <mds-accordion-item description="Centiskorch" closable={args.closable}>
