...
export const VariableDuration = TemplateVariableDuration.bind({})
VariableDuration.args = {
  duration: 3000,
}
...
export const Programmatic = TemplateClickPaused.bind({})
Programmatic.args = {
  paused: true,
}
