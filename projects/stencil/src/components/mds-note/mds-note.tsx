...
export class MdsNote {
  ...
  render () {
    return (
      <Host role="note">
        { this.deletable && <mds-button title={this.t.get('deleteLabel')} icon={miBaselineClose} class="button-close" variant="dark" tone="text" onClick={ this.onClickClose.bind(this) }></mds-button> }
        <slot name="title"/>
        <slot/>
