...
| `strategy` | `strategy` | Specifies the position strategy of the notification                                                                                                | `"absolute" \| "disabled" \| "fixed" \| undefined` | `'fixed'`   |
| `target`   | `target`   | Specifies the id of the caller element.                                                                                                            | `string \| undefined`                              | `null`      |
| `value`    | `value`    | Specifies number of notifications to display, if it set to 0, the element will be hidden                                                           | `number \| undefined`                              | `null`      |
| `visible`  | `visible`  | Specifies if the notification is visible                                                                                                           | `boolean \| undefined`                             | `null`      |
