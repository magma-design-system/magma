...
| `current`           | `current`      | Specifies if the component is the current or not                                      | `boolean \| undefined`                                                                                                                                                 | `false`     |
...
| `selected`          | `selected`     | Specifies if the component is checked or not                                          | `boolean \| undefined`                                                                                                                                                 | `false`     |
