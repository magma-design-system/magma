      ...
      return (
        <Host aria-label={this.alt} role="img">
          ...
          <div class="alt-text-container alt-text-container--error alt-text-container--default-aspect-ratio">
            ...
            <mds-text class="alt-text" aria-hidden="true" typography="h6">
              <i>{this.alt}</i>
            </mds-text>
          </div>
        </Host>
        ...
        return (
          ...
          >
            ...
            {!this.imageConsumptionLoaded ? (
              <div
                aria-hidden="true"
                class="alt-text-container alt-text-container--default-aspect-ratio"
              >
                <mds-icon class="icon" name={miBaselinePanorama}></mds-icon>
                <mds-text class="alt-text" typography="h6">
                  <i>{this.alt}</i>
                </mds-text>
                <mds-button
                  aria-hidden="true"
