  ...
  <div class="grid gap-600">
    <form class="grid gap-400" id="mds-icon-fi" name="mds-icon-fi">
      ...
      <div class="flex flex-wrap gap-400 items-baseline">
        <mds-button class="shrink-0 mobile:grow" type="button" role="submit" onClick={() => {
        ...
        <mds-text variant="code">
          Input value taken from form element <span class="input-value inline-flex rounded text-tone-neutral-04 bg-tone-neutral-08 px-200 transition-transform duration-200">empty</span>
        </mds-text>
      </div>
    </form>
  </div>
