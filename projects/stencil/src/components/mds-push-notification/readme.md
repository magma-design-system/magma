...
| `datetime`   | --            | Specifies the notification date based on [standard ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html).                                | `string & { __isISO8601DateFormat: "ISO8601Date"; } \| undefined`                                                                                                                       | `undefined`                      |
