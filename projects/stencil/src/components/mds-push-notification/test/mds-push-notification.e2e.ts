...
describe('mds-push-notification', () => {
  it('renders', async () => {
    ...
    expect(element.outerHTML).toEqualHtml(`
      <mds-push-notification date-format="timeago" deletable="" hydrated="" message="Nessun messaggio disponibile" preview="image" tone="weak"><template shadowrootmode="open">
