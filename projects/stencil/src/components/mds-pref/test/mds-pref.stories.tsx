...
const TemplateController = () =>
  <div>
    <mds-text>
      When attribute <mds-text typography='snippet'>controller</mds-text> is set, <mds-text typography='snippet'>mds-pref</mds-text> acts as ad hidden element which retrives user preferences from localStorage, it's useful when you dont' need to render the component but you need it sets used preferences based on localStorage method.
    </mds-text>
    <mds-pref controller>
      <mds-pref-theme></mds-pref-theme>
      <mds-pref-contrast></mds-pref-contrast>
...
export const Controller = TemplateController.bind({})
