...
| `tag`        | `tag`        | Specifies the HTML tag of the element                                      | `"small" \| "sub" \| "sup" \| "h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6" \| "strong" \| "label" \| "code" \| "address" \| "time" \| "abbr" \| "article" \| "b" \| "bdo" \| "blockquote" \| "cite" \| "dd" \| "del" \| "details" \| "dfn" \| "div" \| "dl" \| "dt" \| "em" \| "figcaption" \| "i" \| "ins" \| "kbd" \| "legend" \| "li" \| "mark" \| "ol" \| "p" \| "pre" \| "q" \| "rb" \| "rt" \| "ruby" \| "s" \| "samp" \| "span" \| "summary" \| "u" \| "ul" \| "var"` | `undefined` |
