  ...
  <div>
    ...
    <mds-input-switch-group name={args.names[0]}>
      <div className="grid grid-cols-1 gap-4">
        ...
        <mds-input-switch name={args.names[0]} type="radio" value="4">Donno</mds-input-switch>
      </div>
    ...
    <mds-input-switch-group name={args.names[1]}>
      <div className="grid grid-cols-1 gap-4">
        ...
        <mds-input-switch name={args.names[1]} type="radio" value="4">Donna</mds-input-switch>
      </div>
    </mds-input-switch-group>
  </div>
