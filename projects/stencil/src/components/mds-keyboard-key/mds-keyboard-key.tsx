...
import localeEs from '@meta/keyboard/locale.es.json'
import localeIt from '@meta/keyboard/locale.it.json'
...
// import miBaselineKeyboardControlKey from '@icon/mi/baseline/keyboard-control-key.svg'
...
// import miBaselineFirstPage from '@icon/mi/baseline/first-page.svg'
// import miBaselineLastPage from '@icon/mi/baseline/last-page.svg'
...
// import mdiPageFirst from '@icon/mdi/page-first.svg'
// import mdiPageLast from '@icon/mdi/page-last.svg'
// import mdiMultiplication from '@icon/mdi/multiplication.svg'
// import miBaselineAdd from '@icon/mi/baseline/add.svg'
// import mdiArrowTopLeft from '@icon/mdi/arrow-top-left.svg'
// import mdiArrowTopLeft from '@icon/top.svg'
// import miBaselineDivide from '@icon/mi/baseline/divide.svg'
