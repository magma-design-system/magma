...
| Name                                       | Description                                                                                                               |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| `--mds-header-backdrop-background-image`   | Sets the background-image of the backdrop element visibile when the component attribute `appearance` is set to `inline`   |
| `--mds-header-backdrop-filter`             | Sets the backdrop-filter of the backdrop element visibile when the component attribute `appearance` is set to `inline`    |
