...
export class MdsAccordionTimerItem {
   ...
   */
  @Event({ eventName: 'mdsAccordionTimerItemClickSelect' })
  clickSelectEvent: EventEmitter<MdsAccordionTimerItemEventDetail>;

  /**
   * Emits when the accordion is changed from code
   */
  @Event({ eventName: 'mdsAccordionTimerItemSelect' })
  selectEvent: EventEmitter<MdsAccordionTimerItemEventDetail>;

  /**
   * Emits when the accordion is hovered by the mouse
   */
  @Event({ eventName: 'mdsAccordionTimerItemMouseEnterSelect' })
  selectedMouseEnterEvent: EventEmitter<MdsAccordionTimerItemEventDetail>;

  /**
   * Emits when the accordion is hovered by the mouse
   */
  @Event({ eventName: 'mdsAccordionTimerItemMouseLeaveSelect' })
  selectedMouseLeaveEvent: EventEmitter<MdsAccordionTimerItemEventDetail>;
