...
const Template = args =>
  <div class="grid gap-600">
    <mds-text typography="h1" tag="h3" class="desktop:hidden">Choose the plan for you</mds-text>
    <div class="grid tablet:grid-cols-2 mobile:grid-cols-1 gap-600">
      ...
      <mds-price-table {...args} class="desktop:hidden">
        <mds-price-table-list class="bg-label-amaranth-10">
          <mds-text typography="h5" tag="h4" slot="header">Professional plan</mds-text>
          <mds-text typography="detail" slot="header">Piano adatto a liberi professionisti con studi di piccole dimensioni.</mds-text>
          <mds-text typography="h2" tag="h4" slot="price">99€</mds-text>
          <mds-button slot="action" variant="dark">Inizia</mds-button>
        </mds-price-table-list>
        <mds-price-table-features>
          <mds-price-table-features-row>
      ...
      <mds-price-table {...args} class="desktop:hidden">
        <mds-price-table-list class="bg-label-violet-10">
          <mds-text typography="h5" tag="h4" slot="header">Enterprise plan</mds-text>
          <mds-text typography="detail" slot="header">Piano adatto a liberi professionisti con studi di piccole dimensioni.</mds-text>
          <mds-text typography="h2" tag="h4" slot="price">149€</mds-text>
          <mds-button slot="action" variant="dark">Inizia</mds-button>
        </mds-price-table-list>
        <mds-price-table-features>
          <mds-price-table-features-row>
    ...
    <mds-price-table {...args} class="tablet-max:hidden">
      <mds-price-table-header {...args} class="mobile:grid-cols-1 tablet:grid-cols-3 desktop:grid-cols-4">
        <mds-text typography="h1" tag="h3" class="tablet:col-span-3 col-span-1 desktop:col-span-1 desktop:py-600">Choose the plan for you</mds-text>
        <mds-price-table-list>
          <mds-text typography="h5" tag="h4" slot="header">Basic plan</mds-text>
          <mds-text typography="detail" slot="header">Piano adatto a liberi professionisti con studi di piccole dimensioni.</mds-text>
          <mds-text typography="h2" tag="h4" slot="price">49€</mds-text>
