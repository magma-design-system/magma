...
const Template = args =>
  <mds-kpi {...args}>
    <mds-kpi-item value="75" description="Allenatori">
      <div slot="icon" className="bg-label-sky-09 fill-label-sky-04 p-6 pb-3 w-full flex justify-center items-center">
...
const TemplateScroll = args =>
  <div>
    <div className="flex min-h-screen pb-8">
      <div className="bg-label-orchid-10 flex flex-grow p-4 flex-col items-center justify-center rounded-3xl text-center fill-label-orchid-04">
    ...
    <mds-kpi {...args}>
      <mds-kpi-item value="451" description="Progetti">
        <div slot="icon" className="bg-label-sky-10 fill-label-sky-04 p-6 pb-3 w-full flex justify-center items-center">
