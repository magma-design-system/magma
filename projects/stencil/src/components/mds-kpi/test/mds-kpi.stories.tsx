...
export default {
  ...
  argTypes: {
    description: {
      ...
      description:
        'Specifies the description under the label in the KPI element',
    },
    label: {
      ...
      <div class="bg-label-orchid-10 flex flex-grow p-400 flex-col items-center justify-center rounded-3xl text-center fill-label-orchid-04">
        <div class="flex-grow flex flex-col items-center justify-center">
          <mds-text typography="detail">
            Scroll the page down to see text entrance effect.
          </mds-text>
          <mds-text typography="caption">(It will trigger once)</mds-text>
        </div>
        <div class="flex-grow flex ">
          <mds-icon
            name="mi/round/arrow-circle-down"
            class="self-end animate-bounce"
          />
        </div>
      </div>
    </div>
