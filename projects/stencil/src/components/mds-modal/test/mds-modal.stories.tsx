...
const Template = args =>
  <mds-modal {...args}>
    <header slot="top" class="p-8 max-w-lg flex gap-4 items-center border-b border-adjust-tone-09">
      <mds-img class="w-16" src="/logo-gruppo-maggioli-512w.webp"/>
      <div class="text-adjust-tone-02">
    ...
    <footer slot="bottom" class="p-8 max-w-lg flex gap-4 text-adjust-tone-02 border-t border-adjust-tone-09">
      <mds-author>
      ...
      <mds-button icon="mdi/dots-vertical" class="ml-auto bg-transparent text-adjust-tone-02 p-4 border border-adjust-tone-09 rounded-full"/>
    </footer>
  </mds-modal>
