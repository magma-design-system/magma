...
| `variant`            | `variant`    | Sets the color variant of the component                            | `"info" \| "error" \| "success" \| "warning" \| "amaranth" \| "red" \| "aqua" \| "blue" \| "green" \| "lime" \| "orange" \| "orchid" \| "purple" \| "sky" \| "violet" \| "yellow" \| "dark" \| "ai" \| "primary" \| "secondary" \| undefined` | `'primary'` |
