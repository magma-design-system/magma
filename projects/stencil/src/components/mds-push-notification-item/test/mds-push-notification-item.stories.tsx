...
import { notificationItemPreviewDictionary, notificationItemDateFormatDictionary } from '../meta/dictionary'
...
export default {
  ...
  argTypes: {
    ...
    deletable: {
      type: { name: 'boolean' },
      description: 'Specifies if the component is dismissable or not, it should be set to true by default is used with it\'s parent component `mds-push-notification-items`',
    },
    icon: {
      type: { name: 'string' },
