...
| `shiftPadding`  | `shift-padding`  | Sets a safe area distance between the dropdown and the body.                          | `24`                                                                                                                                                                 | `24`       |
| `smooth`        | `smooth`         | If set, the component will follow the caller smoothly.                                | `boolean`                                                                                                                                                            | `true`     |
