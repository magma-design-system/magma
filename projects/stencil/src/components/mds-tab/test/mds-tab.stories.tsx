    ...
    <div class="grid gap-600">
      ...
      {currentElement === 0 && (
        <div class="min-h-[400px] flex items-center justify-center p-600 bg-label-amaranth-09 rounded-2xl">
          <mds-text>This is the first tab contents</mds-text>
        </div>
      )}
      {currentElement === 1 && (
        <div class="min-h-[400px] flex items-center justify-center p-600 bg-label-blue-09 rounded-2xl">
          <mds-text>This is the second tab contents</mds-text>
        </div>
      )}
      {currentElement === 2 && (
        <div class="min-h-[400px] flex items-center justify-center p-600 bg-label-green-09 rounded-2xl">
          <mds-text>This is the third tab contents</mds-text>
        </div>
      )}
    </div>
  );
...
const TemplateScroll = () => (
  <div class="grid gap-600 pt-[60px]">
    ...
    <div class="grid gap-600">
      <SectionComponent
        id="section-1"
        className="bg-label-amaranth-09 min-h-screen"
        title="Section 1"
      />
      <SectionComponent
        id="section-2"
        className="bg-label-blue-09 min-h-screen"
        title="Section 2"
      />
      <SectionComponent
        id="section-3"
        className="bg-label-orange-09 min-h-screen"
        title="Section 3"
      />
    </div>
  </div>
    ...
    <div class="grid gap-600 pt-[60px]">
      <mds-tab>
        ...
        <SectionComponent
          id="section-1"
          slot="content"
          className="bg-label-amaranth-09 mt-400"
          title="Section 1"
        />
        {tabContentLoaded && (
          <SectionComponent
            id="section-2"
            slot="content"
            className="bg-label-blue-09 mt-400"
            title="Section 2"
          />
        )}
        <SectionComponent
          id="section-3"
          slot="content"
          className="bg-label-orange-09 mt-400"
          title="Section 3"
        />
      </mds-tab>
    </div>
