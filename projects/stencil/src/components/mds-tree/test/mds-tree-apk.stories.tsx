      ...
      <mds-tree-item label="Protocollazione documenti" style={{ '--mds-tree-label-hover-background': 'rgb(var(--variant-primary-10))' }}>
        <mds-tree-item label="Attività protocollo generale">
          ...
          <mds-tree-item label="Nuovo protocollo in partenza">
            <mds-button slot="action" icon="mi/baseline/favorite-border" class="fill-tone-neutral-07" variant="dark" tone="quiet"></mds-button>
          </mds-tree-item>
        </mds-tree-item>
...
const TemplateOrganizationalChart = () => {
  ...
  return <mds-tree toggle="chevron" toggle-position="right">
          ...
          <mds-tree-item label="Assessorato" icon="mi/baseline/account-balance">
            <mds-tree-item label="Settore" icon="mi/baseline/location-city">
              <mds-tree-item label="Sezione" icon="mi/baseline/meeting-room">
                ...
                <mds-tree-item label="Ufficio" icon="mi/baseline/desk" async class="mds-tree-item">
                  <mds-tree-item label="Andrea Rossi" icon="mi/baseline/person"></mds-tree-item>
                  <mds-tree-item label="Mirco Romanelli" icon="mi/baseline/person"></mds-tree-item>
                  <mds-tree-item label="Elone Muschio" icon="mi/baseline/person"></mds-tree-item>
                </mds-tree-item>
              </mds-tree-item>
            </mds-tree-item>
...
const TemplateWorkflow = () =>
  <mds-tree toggle="folder" toggle-position="left" actions="visible" style={{ '--mds-tree-toggle-icon-folder-default-color': 'rgb(var(--tone-neutral-04))' }}>
    <mds-tree-item label="Nr: 144 Data: 29/01/2025 (DIREZIONE GENERALE)">
      <div slot="action" title="Protocollo generale in uscita" class="flex items-center gap-50 text-label-orange-03 bg-label-orange-09 fill-label-orange-04 p-100 pl-200 rounded-md">
      ...
      <mds-tree-item label="Settore Data: 29/01/2025 (direzione generale)">
        <div slot="action" title="Messaggio interno in entrata" class="flex items-center gap-50 text-label-blue-03 bg-label-blue-09 fill-label-blue-04 p-100 pl-200 rounded-md">
...
const TemplateClassification = () => {
  ...
  return <mds-tree toggle="chevron" toggle-position="left">
    <mds-tree-item label="Titolario">
      <mds-tree-item label="1 - AMMINISTRAZIONE GENERALE (Non Utilizzare)">
        <mds-tree-item label="1.0.0 - AMMINISTRAZIONE GENERALE (Non Utilizzare" async class="mds-tree-item">
...
export const NavigationMenu = TemplateNavigationMenu.bind({})
export const OrganizationalChart = TemplateOrganizationalChart.bind({})
export const Workflow = TemplateWorkflow.bind({})
export const Classification = TemplateClassification.bind({})
