...
export const typographyVariationsDictionary = [
  'title',
  'info',
  'read',
  'code',
...
export const typographyReadDictionary = [
  'caption',
  'detail',
  'paragraph',
] as const
...
export const typographyInputDictionary = [
  'snippet',
  'detail',
] as const
export type TypographyInputType = (typeof typographyInputDictionary)[number]

export const typographyTechnicalDictionary = [
  'option',
  'label',
] as const
