...
const main = async () => {
  console.info(
    `This script will ${chalk.green('generate')} or ${chalk.yellow('re-generate')} the ${chalk.magenta(gitlabCiYmlFileName)} file for each stencil component based on the template located in the template folder`,
  );
