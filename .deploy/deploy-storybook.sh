...
envsubst < .deploy/$ENV/docker-compose-storybook.yml > .deploy/$ENV/docker-compose.yml.replaced
rm .deploy/$ENV/docker-compose-storybook.yml && mv .deploy/$ENV/docker-compose.yml.replaced .deploy/$ENV/docker-compose.yml
